...
Player Diary for <? echo $username;?></div></td>
...
<P>
The following lists games played by <? echo $username; ?>.<p>
<?
##############################################################################
# FUNCTION:     printPageList
# AUTHOR:       Andrew Roth, John Morrison
# DATE:         02/03/03
# RETURNS:
# PURPOSE:
...
function printPageList($start, $numItems, $url, $username) {
	...
	echo "<center>";
	printPageList($start, $numServers, "playerdiary.php", $username);
	echo "</center>";
